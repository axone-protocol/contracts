# Untitled undefined type in okp4-triplestore Schema

```txt
undefined#/execute/definitions/ResourceCriteria/oneOf/2/properties/referenced/properties/referer/allOf/0
```
