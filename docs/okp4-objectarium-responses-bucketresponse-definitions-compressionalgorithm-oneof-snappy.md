...
```txt
undefined#/responses/bucket/definitions/CompressionAlgorithm/oneOf/1
```
...
`string` ([Snappy](okp4-objectarium-responses-bucketresponse-definitions-compressionalgorithm-oneof-snappy.md))
